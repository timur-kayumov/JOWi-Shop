...
import type {
  StoreTransferDetail,
  StoreTransferLineItem,
  Activity,
} from '@/types/store-transfer';
import {
  mockStoreTransferDetails,
  mockStoreTransferComments,
  mockStoreTransferActivities,
} from '@/types/store-transfer';
...
export default function StoreTransferDetailPage() {
  ...
  // Get mock data for this store transfer
  const mockTransfer = mockStoreTransferDetails[transferId];
  const mockComments = mockStoreTransferComments[transferId] || [];
  const mockActivities = mockStoreTransferActivities[transferId] || [];

  // State management
  const [transfer, setTransfer] = useState<StoreTransferDetail | null>(mockTransfer);
  const [lineItems, setLineItems] = useState<StoreTransferLineItem[]>(
    mockTransfer?.lineItems || []
  );
  const [originalLineItems, setOriginalLineItems] = useState<StoreTransferLineItem[]>(
    mockTransfer?.lineItems || []
  );
  ...
  // Navigation
  const handleBack = () => {
    router.push(`/store/${params.id}/documents/store-transfers`);
  };
  ...
  const confirmPublish = () => {
    if (transfer) {
      ...
      const newActivity: Activity = {
        ...
        description: t('documents.storeTransfers.detail.toasts.publishSuccess'),
        newStatus: '?C1;8:>20=>',
        timestamp: new Date(),
      };
  ...
  const confirmCancel = () => {
    if (transfer) {
      ...
      const newActivity: Activity = {
        ...
        userId: currentUserId,
        userName: transfer.responsibleName,
        description: t('documents.storeTransfers.detail.toasts.cancelSuccess'),
        newStatus: 'B<5=5=>',
        timestamp: new Date(),
      };
      setActivities([...activities, newActivity]);
  ...
  // Table columns
  const transferColumns: Column<StoreTransferLineItem>[] = [];
  ...
  transferColumns.push({
    key: 'productName',
    label: t('documents.storeTransfers.detail.table.product'),
    render: (item) => (
      <div>
  ...
  if (showAvailableColumn) {
    transferColumns.push({
      key: 'available',
      label: t('documents.storeTransfers.detail.table.available'),
      className: 'w-[140px]',
      render: (item) => (
  ...
  transferColumns.push({
    key: 'quantity',
    label: t('documents.storeTransfers.detail.table.quantity'),
    className: 'w-[180px]',
    render: (item) =>
      canEditQuantity ? (
        <InputGroup>
  ...
  transferColumns.push({
    key: 'price',
    label: t('documents.storeTransfers.detail.table.price'),
    className: 'w-[180px]',
    render: (item) =>
      canEditPrices ? (
        <InputGroup>
          ...
          />
          <InputGroupAddon side="right">
            <InputGroupText>сум</InputGroupText>
          </InputGroupAddon>
        </InputGroup>
      ) : (
  ...
  transferColumns.push({
    key: 'amount',
    label: t('documents.storeTransfers.detail.table.amount'),
    className: 'w-[180px]',
    render: (item) =>
      canEditPrices ? (
        <InputGroup>
    ...
    return (
      <div className="flex h-[50vh] items-center justify-center">
        <p className="text-muted-foreground">
          {t('documents.storeTransfers.detail.table.noProducts')}
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <Button variant="ghost" onClick={handleBack} className="gap-2">
        ...
        {t('documents.storeTransfers.detail.backToList')}
      </Button>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <span className="flex-1 text-sm text-muted-foreground">
                    {t('documents.storeTransfers.detail.sourceWarehouse')}
                  </span>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <span className="flex-1 text-sm text-muted-foreground">
                    {t('documents.storeTransfers.detail.destinationStore')}
                  </span>
                  <span className="text-right text-sm font-medium">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <span className="flex-1 text-sm text-muted-foreground">
                    {t('documents.storeTransfers.detail.destinationWarehouse')}
                  </span>
                  <span className="text-right text-sm font-medium">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <span className="flex-1 text-sm text-muted-foreground">
                    {t('documents.storeTransfers.detail.created')}
                  </span>
                  <span className="text-right text-sm font-medium">
                ...
                {transfer.publishedAt && (
                  <div className="flex items-start gap-3">
                    <Calendar className="mt-0.5 h-4 w-4 flex-shrink-0 text-muted-foreground" />
                    <span className="flex-1 text-sm text-muted-foreground">
                      {t('documents.storeTransfers.detail.published')}
                    </span>
                    <span className="text-right text-sm font-medium">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <span className="flex-1 text-sm text-muted-foreground">
                    {t('documents.storeTransfers.detail.responsible')}
                  </span>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <span className="flex-1 text-sm text-muted-foreground">
                    {t('documents.storeTransfers.detail.itemsCount')}
                  </span>
                ...
                <div className="flex items-center gap-2 pt-4 border-t">
                  <div className="flex items-center gap-2">
                    {canDelete && (
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>{t('documents.storeTransfers.detail.actions.delete')}</p>
                        </TooltipContent>
                      </Tooltip>
                    )}
                    {canEdit && (
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>{t('documents.storeTransfers.detail.actions.edit')}</p>
                        </TooltipContent>
                      </Tooltip>
                    )}
                  </div>
                  ...
                  {canPublish && (
                    ...
                    >
                      ...
                      {t('documents.storeTransfers.detail.actions.publish')}
                    </Button>
                  )}
                  {canCancelTransfer && (
                    <Button variant="outline" onClick={handleCancel} size="sm">
                      <XCircle className="mr-2 h-4 w-4" />
                      {t('documents.storeTransfers.detail.actions.cancel')}
                    </Button>
                  )}
                </div>
              </TooltipProvider>
            ...
            <Tabs value={leftTab} onValueChange={(value) => setLeftTab(value as any)}>
              <TabsList className="grid w-full grid-cols-2">
                <TabsTrigger value="comments">
                  {t('documents.storeTransfers.detail.comments')}
                </TabsTrigger>
                <TabsTrigger value="history">
                  {t('documents.storeTransfers.detail.history')}
                </TabsTrigger>
              </TabsList>
          ...
          <div className="grid grid-cols-3 gap-4">
            <Card className="p-4">
              <p className="text-sm text-muted-foreground mb-1">
                {t('documents.storeTransfers.detail.kpi.costPrice')}
              </p>
              <p className="text-2xl font-bold">{formatCurrency(kpiMetrics.costPrice)}</p>
            </Card>
            <Card className="p-4">
              <p className="text-sm text-muted-foreground mb-1">
                {t('documents.storeTransfers.detail.kpi.total')}
              </p>
              <p className="text-2xl font-bold">{formatCurrency(kpiMetrics.total)}</p>
            </Card>
            <Card className="p-4">
              <p className="text-sm text-muted-foreground mb-1">
                {t('documents.storeTransfers.detail.kpi.profit')}
              </p>
              <p
              ...
              >
                {kpiMetrics.profit >= 0 ? '+' : ''}
                {formatCurrency(Math.abs(kpiMetrics.profit))}
              </p>
            </Card>
          </div>
          ...
          <div className="space-y-0">
            ...
            <Card className="rounded-b-none p-6">
              <div className="flex items-center gap-2">
                ...
                <div className="relative flex-1">
                  ...
                  <Input
                    placeholder={t('documents.storeTransfers.detail.searchProducts')}
                    value={searchQuery}
                ...
                {canAddRemoveItems && selectedItems.size > 0 && (
                  <Button variant="destructive" onClick={handleDeleteSelected}>
                    {t('documents.storeTransfers.detail.deleteSelected')} ({selectedItems.size})
                  </Button>
                )}
                ...
                {canAddRemoveItems && (
                  <Button onClick={() => setAddProductsDialogOpen(true)}>
                    {t('documents.storeTransfers.detail.addProducts')}
                  </Button>
                )}
                ...
                {transfer.status === 'published' && hasUnsavedChanges && (
                  <Button onClick={handleSaveChanges}>
                    {t('documents.storeTransfers.detail.saveChanges')}
                  </Button>
                )}
              </div>
            </Card>
            ...
            <Card className="rounded-t-none border-t-0">
              <DataTable
                ...
                emptyMessage={t('documents.storeTransfers.detail.table.noProducts')}
              />
            </Card>
          </div>
        </div>
      ...
      <Dialog open={publishDialogOpen} onOpenChange={setPublishDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {t('documents.storeTransfers.detail.confirmDialogs.publish.title')}
            </DialogTitle>
            <DialogDescription>
              {t('documents.storeTransfers.detail.confirmDialogs.publish.message')}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
      ...
      <Dialog open={cancelDialogOpen} onOpenChange={setCancelDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {t('documents.storeTransfers.detail.confirmDialogs.cancel.title')}
            </DialogTitle>
            <DialogDescription>
              {t('documents.storeTransfers.detail.confirmDialogs.cancel.message')}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {t('documents.storeTransfers.detail.confirmDialogs.delete.title')}
            </DialogTitle>
            <DialogDescription>
              {t('documents.storeTransfers.detail.confirmDialogs.delete.message')}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            ...
            <Button onClick={confirmDelete} variant="destructive">
              {t('documents.storeTransfers.detail.actions.delete')}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={addProductsDialogOpen} onOpenChange={setAddProductsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {t('documents.storeTransfers.detail.confirmDialogs.addProducts.title')}
            </DialogTitle>
            <DialogDescription>
              {t('documents.storeTransfers.detail.confirmDialogs.addProducts.description')}
            </DialogDescription>
          </DialogHeader>
          <div className="py-4">
            <p className="text-center text-muted-foreground">
              {t('documents.storeTransfers.detail.confirmDialogs.addProducts.noProductsAvailable')}
            </p>
          </div>
          <DialogFooter>
            ...
            <Button disabled>
              {t('documents.storeTransfers.detail.confirmDialogs.addProducts.addSelected')}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
